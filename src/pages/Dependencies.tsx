  ...
  return (
    <>
      <PageHead title="HTTP dependencies">
        Every outbound call that goes through <code>AxiosService</code> — D03
        factories <code>this.get</code> / <code>this.getMany</code>, SAP/IKM/PNS{" "}
        <code>this.axios.post</code>, and the rest. A use case is listed only
        when its entry method actually reaches that client method.
      </PageHead>
      ...
      <div className="toolbar">
        ...
        <span className="dimmer" style={{ fontSize: 12.5, marginLeft: "auto" }}>
          {clients.length.toLocaleString()} of{" "}
